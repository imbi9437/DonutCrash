...
public class QueenCardBuff : BuffBase
{
    public QueenCardBuff(SkillData skillData, IBuffable buffOwner, IBuffable buffContainer, int stack = 1) : base(skillData, buffOwner, buffContainer, skillData.cooldown) { }
