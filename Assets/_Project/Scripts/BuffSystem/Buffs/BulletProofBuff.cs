...
public class BulletProofBuff : BuffBase
{
    public BulletProofBuff(SkillData skillData, IBuffable buffOwner, IBuffable buffContainer, int stack = 1) : base(skillData, buffOwner, buffContainer, skillData.cooldown) { }
    ...
    {
        donutInGameData.def = (int)(donutInGameData.def * (1 + skillData.fValue1));
